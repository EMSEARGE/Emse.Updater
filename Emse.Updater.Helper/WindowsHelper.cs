...
namespace Emse.Updater.Helper
{
    ...
    {
        [Flags]
        public enum ExitWindowsType : uint
        {
            LogOff = 0x00,
            ShutDown = 0x01,
            ForceShutdown = 0x05,
        ...
        private static extern int ExitWindowsEx(ExitWindowsType uFlags, ShutdownReason dwReason);

        public static bool ExitWindows(ExitWindowsType exitWindows, ShutdownReason reason, bool ajustToken)
        {
